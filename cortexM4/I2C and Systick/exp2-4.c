...
volatile uint16_t systick_10ms_couter,systick_100ms_couter,systick_1000ms_couter,
	systick_2000ms_couter,systick_200ms_couter,systick_500ms_couter;
volatile uint8_t	systick_10ms_status,systick_100ms_status,systick_1000ms_status,
	systick_2000ms_status,systick_200ms_status,systick_500ms_status;

volatile uint8_t result,cnt,key_value,gpio_status;
volatile uint8_t rightshift = 0x1f, min = 0x3, sec = 0x18, sig = 0x4;
uint32_t ui32SysClock;
uint8_t seg7[] = {0x3f,0x06,0x5b,0x4f,0x66,0x6d,0x7d,0x07,0x7f,0x6f,0x77,0x7c,0x58,0x5e,0x079,0x71,0x5c};

int count = 0, mincnt = 0, seccnt = 0;

int main(void)
{
	volatile uint16_t	i2c_flash_cnt,gpio_flash_cnt;
	int j, thres = 10, interval = 20000;
  ...
  IntMasterEnable();		
	...
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[0]);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,sec);
	
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[0]);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,min);
	...
	while (1)
	{
		...
		for(j=0;j<thres;++j){
			I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[seccnt/10]);
			I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,0x8);
			Delay(interval);
			I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[seccnt%10]);
			...
			I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[mincnt/10]);
	...
	if(count==1){
		...
		if (systick_2000ms_status)
		{
			systick_2000ms_status	= 0;
			if (++i2c_flash_cnt		>= I2C_FLASHTIME/100)
			{
...
void SysTick_Handler(void)
{
	...
	{
		systick_1000ms_couter		= SYSTICK_FREQUENCY/1;
		systick_1000ms_status 	= 1;
	}
	
	if (systick_2000ms_couter	!= 0)
		systick_2000ms_couter--;
	else
	{
		systick_2000ms_couter		= SYSTICK_FREQUENCY/0.5;
		systick_2000ms_status 	= 1;
	}
